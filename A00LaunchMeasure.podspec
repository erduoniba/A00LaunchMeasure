...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of A00LaunchMeasure.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/denglibing5/A00LaunchMeasure'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'denglibing5' => 'denglibing3@jd.com' }
  s.source           = { :git => 'https://github.com/denglibing5/A00LaunchMeasure.git', :tag => s.version.to_s }
